...
/***/ function(module, exports, __webpack_require__) {
	...
	var Data = _react2.default.createClass({
	  ...
	  update: function update() {
	    ...
	    _superagent2.default.get('/data').end(function (err, res) {
	      console.log(res);
	      _this.setState({
	        data: {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(FileList, { list: this.state.data.filesList }),
	      _react2.default.createElement(Sensors, { sensors: this.state.data.sensors })
	    );
	  }
	});
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'ul',
	        null,
	        this.props.list.map(function (file, index) {
	          return _react2.default.createElement(
	            'li',
	            { key: file.name },
	            index + 1,
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        null,
	        'date: ',
	        this.props.sensors.date
	      ),
	      _react2.default.createElement(
	        'li',
	        null,
	        'cputemp: ',
	        this.props.sensors.cputemp
	      ),
	      _react2.default.createElement(
	        'li',
	        null,
	        'pingtime: ',
	        this.props.sensors.pingtime
	      )
	    );
	  }
	});

	_reactDom2.default.render(_react2.default.createElement(Data, null), document.getElementById('main'));
